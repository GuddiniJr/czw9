...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        {
            var resL = Emps.Where(emp => emp.Job == "Frontend programmer" && emp.Salary > 1000).OrderByDescending(emp => emp.Ename);
        }
        ...
        public void Przyklad7()
        {
            ...
            var res = Emps.GroupBy(e => e.Job).Select(e => new
            {
                e.Key,
                count = e.Count()
            });
        ...
        public void Przyklad10()
        {
            ...
            var res = Emps.Union(list).Select(e => new
            {
                e.Ename,
                e.Job,
                e.HireDate
        ...
        {
            Emps.SelectMany(emp => Depts, (emp, dept) => new
            {
